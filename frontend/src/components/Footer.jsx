    ...
    <footer className="bg-secondary pt-20 pb-10">
      <div className="container mx-auto px-4 md:px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div className="space-y-6">
            ...
            <p className="text-gray-600 leading-relaxed">
              Delicious moments await at Bites. We serve fresh, authentic Nepali
              flavors in a cozy atmosphere designed for memorable dining
            ...
            <div className="flex gap-4">
              {[Instagram, Facebook, Twitter].map((Icon, i) => (
                <a
                  key={i}
                  href="#"
                  className="w-10 h-10 rounded-full bg-white flex items-center justify-center text-primary shadow-sm hover:bg-primary hover:text-white transition-all duration-300"
                >
                  <Icon size={18} />
                </a>
              ))}
          ...
          <div>
            ...
            <ul className="space-y-5">
              <li className="flex gap-3 text-gray-600">
                ...
                <span>Chauthe-14, Pokhara, Nepal</span>
              </li>
              <li className="flex gap-3 text-gray-600">
        ...
        <div className="border-t border-gray-200 pt-8 text-center text-gray-500 text-sm">
          <p>Copyright © 2026 Bites Restaurant. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
