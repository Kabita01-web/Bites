...
const dishes = [
  {
    ...
    price: "$45",
    description:
      "45-day aged ribeye with black truffle butter and roasted garlic mash.",
    image:
      "https://images.unsplash.com/photo-1546241072-48010ad28c2c?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80",
  },
  {
    name: "Wild Mushroom Risotto",
    price: "$28",
    description:
      "Creamy Arborio rice with porcini mushrooms, parmesan, and fresh herbs.",
    image:
  ...
  },
  {
    ...
    price: "$32",
    description:
      "Diver scallops with pea purée, crispy pancetta, and lemon emulsion.",
    image:
