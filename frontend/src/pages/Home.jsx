  ...
  const featuredDishes = [
    {
      ...
      description:
        "Premium wagyu beef, caramelized onions, truffled aioli, and brioche bun.",
      price: "$24",
      image:
    ...
    },
    {
      ...
      description:
        "Hand-made linguine with wild basil pesto and toasted sicilian pistachios.",
      price: "$22",
      image:
    ...
    },
    {
      ...
      description:
        "45-day dry-aged ribeye served with bone marrow butter and roasted herbs.",
      price: "$48",
      image:
    ...
    },
    {
      ...
      description:
        "Melted dark chocolate heart, vanilla bean gelato, and berry reduction.",
      price: "$14",
      image:
