      ...
      <div className="pt-40 pb-32 flex items-center justify-center px-4">
        ...
        >
          ...
          <p className="text-gray-600 text-lg mb-10 leading-relaxed">
            Thank you {user.username} for choosing Bites. We've sent a
            confirmation email to {user.email} with your reservation details.
            See you soon!
          </p>
          <button
    ...
    <div className="pt-28 bg-white min-h-screen">
      ...
      <section className="bg-secondary mb-20 py-24 text-center">
        <div className="container mx-auto px-4">
          ...
          <h1 className="text-5xl md:text-7xl font-serif font-bold text-gray-800 mt-4 leading-tight">
            Book a Table
          </h1>
        ...
        <div className="container mx-auto max-w-4xl">
          ...
          >
            <form onSubmit={handleSubmit} className="space-y-10">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                ...
                <div className="space-y-4">
                  ...
                  <input
                    ...
                    value={user.username}
                    readOnly
                    className="w-full px-8 py-4 bg-gray-100 rounded-2xl border border-gray-200 outline-none font-medium text-gray-600 cursor-not-allowed"
                  />
                </div>
              ...
              {/* Special Requests */}
              <div className="space-y-4">
                <label className="text-sm font-bold text-primary uppercase ml-2">
                  Special Requests
                </label>
                <textarea
                  rows="4"
              ...
              <div className="pt-6">
                ...
                <p className="text-center text-gray-400 text-sm mt-6 italic">
                  By clicking confirm, you agree to our booking policy and terms
                  of service.
                </p>
              </div>
            </form>
